    ...
    Menus = [
      {
        ...
        href: "/",
        icon: (
          <RiDashboardFill className={`text-3xl cursor-pointer duration-500`} />
        ),
      },
      {
        title: "Productos",
        href: "/products",
        icon: <BiBarcode className={`text-3xl cursor-pointer duration-500`} />,
      },
      {
        title: "Usuarios",
        href: "/users",
        icon: <HiUser className={`text-3xl cursor-pointer duration-500`} />,
      },
      {
        title: "Ventas",
        href: "/sales",
        icon: (
          <FaMoneyBillWave className={`text-3xl cursor-pointer duration-500`} />
        ),
      },
    ];
        ...
        <div>
          ...
          <div className="flex gap-x-4 items-center justify-left pl-8">
            <img
              src={brandLogo}
              alt=""
              className={`$ w-40 text-main-white cursor-pointer`}
            />
          </div>
        ...
        <div className="main-container flex overflow-hidden">
          <div className="flex justify-between items-center navbar fixed top-0 w-full bg-main-gray z-9">
            <img
              src={brandLogo}
              alt=""
              className="w-40 text-main-white cursor-pointer ml-8"
            />
          ...
          <div
            className={` ${
              isDashboardOpen ? "w-72" : "w-20"
            } mt-32 deskopt-navbar h-screen duration-300 p-5 pt-8 pb-8 pl-4 pr-4 rounded-3xl relative top-0 left-0 m-5 flex flex-col items-center`}
            style={{ height: "calc(86vh - 45px)" }}
          >
            <div className="flex gap-x-4 items-center justify-center">
              <img
                src={userImg}
                alt=""
                className={`w-12 text-main-white cursor-pointer duration 500`}
              />
              <h1
                className={`${
                  !isDashboardOpen && "hidden"
                } text-main-dark origin-left duration-300 text-xl`}
              >
                {sesion.name}
              </h1>
            </div>
            <BsArrowRightSquareFill
              ...
              } text-4xl absolute cursor-pointer -right-3 top-9 w-7`}
            />
            <ul className="pt-6">
              {Menus.map((menu, index) => (
                <Link
                  key={index}
                  to={menu.href}
                  className={`text-sm flex items-center gap-x-4 cursor-pointer p-2 pl-8 pr-8 mb-3 sm:pl-4 sm:pr-4 hover:bg-main-dark hover:text-main-white rounded-md ${
